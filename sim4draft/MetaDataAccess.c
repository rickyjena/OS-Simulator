...
Precondition: file is open and file cursor is at beggining
              of an op code
Postcondition: in correct opperation,
...
Exceptions: correctly and appropriately (without program failure)
            respond to and reports file access failure,
...
Postcondition: assigns new structure node to beggining of linked list
...
Postcondition: error meassage is displayed with the correct
               local error item
Exceptions: none
Notes: none
*/
